...
export class Admissions extends React.Component {
  ...
  constructor(props) {
    ...
    this.studentsURL = baseURL + 'students/status/9870326110';
...
export default withRouter(withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(Admissions)))
